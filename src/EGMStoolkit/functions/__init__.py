"""
Function components of **EGMS toolkit**

The module contains the different functions required by `EGMStoolkit`.

Changelog:
        * 0.2.10: Fix regarding the input and output directory for data gridding, Aug. 2024, Alexis Hrysiewicz
        * 0.2.6: Bug fixes regarding the windows system, Feb. 2024, Alexis Hrysiewicz
